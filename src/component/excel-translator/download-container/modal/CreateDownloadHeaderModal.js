...
import { Container, GroupTitle, BodyContainer, DataWrapper, DataInputEl, CustomDataGroup, UploadDataGroup, DownloadDataGroup, DownloadInfo, DeleteBtn, DataGroup, ArrowSpan, FormInput, CreateBtn, DataContainer } from './styles/CreateDownloadHeader.styled'
...
export default function CreateDownloadHeaderModal(props) {
    ...
    const getUploadHeaderName = (targetCellNumber) => {
        let result = props.selectedHeader?.uploadHeaderDetail.details.filter(r => r.cellNumber === targetCellNumber)[0];
    ...
    return (
        <>
            <Container>
                <form onSubmit={(e) => props.handleUpdateDownloadHeader(e)}>
                    ...
                    <BodyContainer>
                        <DataContainer>
                            {props.headerDetails?.map((downloadHeader, idx) => {
                                                            ...
                                                            <Box sx={{ display: 'flex' }}>
                                                                <FormControl fullWidth>
                                                                    ...
                                                                    <Select
                                                                        ...
                                                                        disabled={isChecked}
                                                                    >
                                                                        {props.selectedHeader?.uploadHeaderDetail.details.map((headerTitle, idx2) => {
                                                                            return (
